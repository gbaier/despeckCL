                    ...
                    stats dissim_stats)
{
    ...
    cl::Buffer covmat_ori                 {context, CL_MEM_READ_WRITE, dimension * dimension * n_elem_overlap * sizeof(float), NULL, NULL};
    cl::Buffer covmat_rescaled            {context, CL_MEM_READ_WRITE, dimension * dimension * n_elem_overlap * sizeof(float), NULL, NULL};
    cl::Buffer covmat_spatial_avg         {context, CL_MEM_READ_WRITE, dimension * dimension * n_elem_sim     * sizeof(float), NULL, NULL};
    cl::Buffer covmat_filt                {context, CL_MEM_READ_WRITE, dimension * dimension * n_elem_ori     * sizeof(float), NULL, NULL};
