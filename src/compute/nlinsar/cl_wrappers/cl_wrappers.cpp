...
nlinsar::cl_wrappers::cl_wrappers(cl::Context context,
                                  ...
                                  const int block_size) : precompute_patch_similarities_routine    (14,         context, patch_size),
                                                          precompute_similarities_1st_pass_routine (block_size, context),
...
nlinsar::cl_wrappers::cl_wrappers(const cl_wrappers& other) : precompute_patch_similarities_routine    (other.precompute_patch_similarities_routine),
                                                              precompute_similarities_1st_pass_routine (other.precompute_similarities_1st_pass_routine),
