                                         ...
                                         const float alpha)
{
    ...
    cl::Buffer dev_ampl_master {context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, height * width * sizeof(float), sub_insar_data.ampl_master(), NULL};
    cl::Buffer dev_ampl_slave  {context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, height * width * sizeof(float), sub_insar_data.ampl_slave(), NULL};
    cl::Buffer dev_phase       {context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, height * width * sizeof(float), sub_insar_data.phase(), NULL};
